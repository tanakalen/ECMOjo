...
public class DocumentRenderer implements Printable {
  ...
  /** Container to hold the Document. This object will be used to lay out the Document for printing. */
   ...
   * the graphics clip, scaling will be allowed. III. The root view of the
   * JEditorPane is obtained. By examining this root view and all of its
   * children, printView will be able to determine the location of each
   * printable element of the document. IV. If the scaleWidthToFit option is
   * chosen, a scaling ratio is determined, and the graphics2D object is scaled.
   * V. The Graphics2D object is clipped to the size of the printable page. VI.
   * currentPage is checked to see if this is a new page to render. If so,
   * pageStartY and pageEndY are reset. VII. To match the coordinates of the
   * printable clip of graphics2D and the allocation rectangle which will be
   * used to lay out the views, graphics2D is translated to begin at the
   * printable X and Y coordinates of the graphics clip. VIII. An allocation
   * Rectangle is created to represent the layout of the Views.
   * 
   ...
   * than PrinterJob.
   * 
   * @param graphics  Where to draw to.
   ...
   * 
   * @param htmlDocument  The document.
   */
   ...
   * 
   * @param plainDocument  Plain document.
   */
   ...
   * true. II. When a leaf view is taller than the printable area of a page, it
   * cannot, of course, be broken down to fit a single page. Such a View will be
   * printed whenever it intersects with the Graphics2D clip. III. If a leaf
   * view intersects the printable area of the graphics clip and fits vertically
   * within the printable area, it will be rendered. IV. If a leaf view does not
   * exceed the printable area of a page but does not fit vertically within the
   * Graphics2D clip of the current page, the method records that this page
   * should end at the start of the view. This information is stored in
   * pageEndY.
   * 
   ...
   * 
   * @param plainDocument  The plain document.
   */
