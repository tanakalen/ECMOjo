...
<div style="border: 1px solid #e0e0e0; background: #f7f7f7; padding: 4px;">
  ...
  &nbsp;&nbsp;&nbsp;Lawrence P. Burgess, MD -
	...
	&nbsp;&nbsp;&nbsp;Mark T. Ogino, MD -
	   <script type="text/javascript">
	     document.write("<n uers=\"<?php echo str_rot13('mailto:Mark.Ogino@nemours.org'); ?>\"><?php echo str_rot13('Mark.Ogino@nemours.org'); ?></n>".replace(/[a-zA-Z]/g, function(c){return String.fromCharCode((c<="Z"?90:122)>=(c=c.charCodeAt(0)+13)?c:c-26);}));
	   </script><br><br>
	     
	<strong>Developers</strong>: <br>
	&nbsp;&nbsp;&nbsp;Christoph Aschwanden, PhD -
	   <script type="text/javascript">
	     document.write("<n uers=\"<?php echo str_rot13('mailto:christoph.aschwanden@noblemaster.com'); ?>\"><?php echo str_rot13('christoph.aschwanden@noblemaster.com'); ?></n>".replace(/[a-zA-Z]/g, function(c){return String.fromCharCode((c<="Z"?90:122)>=(c=c.charCodeAt(0)+13)?c:c-26);}));
	   </script><br>
	&nbsp;&nbsp;&nbsp;Kin Lik Wang (Alex) -
	   <script type="text/javascript">
	...
	&nbsp;&nbsp;&nbsp;Len Tanaka, MD -
	   <script type="text/javascript">
	     document.write("<n uers=\"<?php echo str_rot13('mailto:lent@hawaii.edu'); ?>\"><?php echo str_rot13('lent@hawaii.edu'); ?></n>".replace(/[a-zA-Z]/g, function(c){return String.fromCharCode((c<="Z"?90:122)>=(c=c.charCodeAt(0)+13)?c:c-26);}));
	   </script><br><br>
